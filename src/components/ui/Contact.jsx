    ...
    return (
        <section className={styles.contact}>
            <div className={styles.contact__container}>
                <Image className={styles.contact__image} src={`${baseUrl}/images/mama-osa.svg`} alt="Mamá Osa - Confitería Artesanal" width={200} height={400} />
                        ...
                        <ul className={styles.contact__list}>
                            <li>
                                <Link className={styles.contact__link} href="https://wa.me/+595971580942" target="_blank" rel="noreferrer">
                                    <Image className={styles.contact__icon} src={`${baseUrl}/images/whatsapp.svg`} alt="Mamá Osa - Confitería Artesanal" width={30} height={30} />
                            ...
                            <li>
                                <Link className={styles.contact__link} href="https://www.instagram.com/mama_osapy/" target="_blank" rel="noreferrer">
                                    <Image className={styles.contact__icon} src={`${baseUrl}/images/instagram.svg`} alt="Mamá Osa - Confitería Artesanal" width={30} height={30} />
                            ...
                            <li>
                                <Link className={styles.contact__link} href="https://www.facebook.com/MamaOsaCA/" target="_blank" rel="noreferrer">
                                    <Image className={styles.contact__icon} src={`${baseUrl}/images/facebook.svg`} alt="Mamá Osa - Confitería Artesanal" width={30} height={30} />
                                    <span>mamaosa</span>
                                </Link>
                            </li>
                        </ul>
